...
/**
 * Created by siddhant on 4/26/17.
 */
public class FloatingWidgetService extends Service implements View.OnClickListener {
    ...
    public static FloatingWidgetService floatingWidgetService;
    ...
    private void addFloatingWidgetView(LayoutInflater inflater) {
        ...
        //openMenu = mFloatingWidgetView.findViewById(R.id.openMenu);
    }
        ...
        switch (v.getId()) {
           // case R.id.close_floating_view:
            ...
            case R.id.open_activity_button:
                ...
                Intent intent = new Intent(FloatingWidgetService.this, DialogMenu.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
